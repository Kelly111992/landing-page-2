...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-[max(0.75rem,env(safe-area-inset-bottom))] right-[max(0.75rem,env(safe-area-inset-right))] md:bottom-7 md:right-7 z-50 flex h-12 w-12 md:h-16 md:w-16 items-center justify-center rounded-full bg-h2pro text-paper shadow-[0_8px_30px_rgba(0,0,0,0.45)] ring-1 ring-paper/25"
    >
      <svg
        viewBox="0 0 448 512"
